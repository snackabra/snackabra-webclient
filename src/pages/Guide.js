  ...
  return (
    ...
    >
      <Typography variant={'h2'} gutterBottom>
        <Trans id='welcome header'>Welcome to the Snackabra</Trans>
      </Typography>
      <Typography variant={'body1'}>
        <Trans id='guide introduction'>For full documentation see <a href="https://snackabra.io">https://snackabra.io</a>. You're probably here because somebody sent you a link or a printed QR code. Welcome!</Trans>
      </Typography>
      <Typography variant={'body1'}>
        <ul>
